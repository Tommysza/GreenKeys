  ...
  return (
    <div className="am" style={{display: "flex", flexDirection: "column"}} id="mission">
      ...
      <Slide style={{backgroundColor: "#00784A", paddingTop: "50px", paddingBottom: "50px"}}>
        ...
        We aim to harness the power of Finance for positive social good and mental health. Through diverse strategies and education, Green Keys @ UChicago will serve as a hotspot for financial learning inside UChicago's intelligent student population. Students searching to meet people and join a community will find a home at Green Keys. <br />
        </Fade></div>
